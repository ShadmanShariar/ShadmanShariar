...
<img src="https://skillicons.dev/icons?i=androidstudio,java,spring,idea,azure,docker,jenkins,kafka,rabbitmq,redis,kubernetes,githubactions,gradle,graphql,hibernate,elasticsearch,python,django,pycharm,c,cpp,javascript,nodejs,html,css,tailwind,bootstrap,vscode,mysql,mongodb,git,github,postman,&theme=light&perline=12" />
</a>
